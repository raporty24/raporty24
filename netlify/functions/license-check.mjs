import { response, parseBody, normalizeLicenseKey, normalizeNip, normalizeProduct, machineHash, storageKeyForLicense, getLicenseStore, isExpired, sanitizePublicLicense, checkProduct } from "./license-lib.mjs";
...
export async function handler(event) {
  ...
  try {
    ...
    if (!checkProduct(license, product)) return response(403, { ok: false, error: "PRODUCT_MISMATCH", expected_product: license.product });
